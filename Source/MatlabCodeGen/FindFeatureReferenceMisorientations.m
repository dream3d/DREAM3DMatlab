...
Filter_Parts{1}{7} = 'GBEuclideanDistancesArrayPath';
Filter_Parts{2}{7} = 'DataArraySelectionWidget';
Filter_Parts{1}{8} = 'FeatureAvgMisorientationsArrayName';
Filter_Parts{2}{8} = 'StringWidget';
Filter_Parts{1}{9} = 'FeatureReferenceMisorientationsArrayName';
