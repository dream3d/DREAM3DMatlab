...
Filter_Parts{1}{4} = 'SurfaceFeaturesArrayPath';
Filter_Parts{2}{4} = 'DataArraySelectionWidget';
Filter_Parts{1}{5} = 'NeighborListArrayPath';
Filter_Parts{2}{5} = 'DataArraySelectionWidget';
Filter_Parts{1}{6} = 'SharedSurfaceAreaListArrayPath';
Filter_Parts{2}{6} = 'DataArraySelectionWidget';
Filter_Parts{1}{7} = 'InputStatsArrayPath';
...
Filter_Parts{1}{9} = 'PhaseTypesArrayPath';
